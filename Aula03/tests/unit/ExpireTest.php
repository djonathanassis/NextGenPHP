...
final class ExpireTest extends TestCase
{
     ...
     */
    public function testExpiresComponentDisplayExpireString(string $method, int $value, string $result): void
    {
        $this->expires->$method($value);
        $this->assertEquals($result, $this->expires->get());
    }

    public function datesMultipleDataProvider(): array
    {
        return [
     ...
     */
    public function testExpiresComponentDisplayMultipleExpireString(array $methods, int $value, string $result): void
    {
    ...
    public function datesMultipleValuesAndMethods(): array
    {
        return [
    ...
    public function testExpiresComponentShouldDisplayNegativeError(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expires->days(-2);
    }

    public function testExpiresComponentShouldDisplayMethodError(): void
    {
